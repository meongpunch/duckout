...
const TEAMS = [
  { id: 'ssg', name: 'SSG 랜더스', logo: '/img/onboarding-logo-ssg.svg' },
  {
    id: 'kiwoom',
    name: '키움 히어로즈',
    logo: '/img/onboarding-logo-kiwoom.svg',
  },
  ...
  { id: 'nc', name: 'NC 다이노스', logo: '/img/onboarding-logo-nc.svg' },
  {
    id: 'samsung',
    name: '삼성 라이온즈',
    logo: '/img/onboarding-logo-samsung.svg',
  },
  {
    id: 'lotte',
    name: '롯데 자이언츠',
    logo: '/img/onboarding-logo-lotte.svg',
  },
  {
    id: 'doosan',
    name: '두산 베어스',
    logo: '/img/onboarding-logo-doosan.svg',
  },
  {
    id: 'hanwha',
    name: '한화 이글스',
    logo: '/img/onboarding-logo-hanwha.svg',
  },
];
